...
const Setting = () => {
    ...
    return (
        <PageContainer heading={`Setting`}>
            <Box display="flex" justifyContent="space-evenly" alignItems="center" width="40%" height="4vh">
                <span
                    style={{ borderBottom:showBorder[0] && "1px solid blue",color:showBorder[0]&&"blue" }}
                ...
                <span
                    style={{  borderBottom:showBorder[1] && "1px solid blue",color:showBorder[1]&&"blue" }}
